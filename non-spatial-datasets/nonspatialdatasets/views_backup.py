...
def create_external_application(request):
    template = "nonspatialdatasets/create_external_application.html"
...
def external_application_metadata_advanced(request, appid):
    return external_application_metadata(
        request,
        appid,
        template='nonspatialdatasets/external_application_metadata_advanced.html')
...
def external_application_metadata_detail(
        request,
        appid,
        template='nonspatialdatasets/external_application_metadata_detail.html'):
    try:
        external_application = _resolve_external_application(
            request,
            appid,
